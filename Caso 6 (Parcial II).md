...
### Preguntas
1. **¿Qué tipo de prototipo sería más adecuado para el sistema de monitoreo (prototipo no operacional, de parches, de características selectas o primero de una serie)? Explica por qué.**
	Prototipo de características selectas
	Un prototipo de características selectas es el más adecuado para un sistema crítico como el monitoreo en tiempo real de una planta de energía. Este enfoque permite que el prototipo se concentre en los componentes más importantes, como la recolección y visualización de datos de equipos clave, sin desarrollar el sistema completo desde el principio. Esto permite evaluar la funcionalidad esencial y recibir retroalimentación temprana de los usuarios (ingenieros y operadores) sobre lo que realmente necesitan. Al mismo tiempo, se reduce el riesgo de comprometer el rendimiento crítico mientras se desarrollan las funciones adicionales de manera gradual.
2. **En un sistema crítico como este, ¿cómo garantizarías que la retroalimentación de los usuarios (ingenieros y operadores) se incorpore adecuadamente en el desarrollo del sistema?**
	
3. **¿Cómo aplicarías el principio ágil de 'retroalimentación constante' para mejorar continuamente el sistema de monitoreo en tiempo real, dado que la planta no puede permitirse errores operativos?**
	
---
4. **¿Qué factores clave deberían considerar para determinar si el proyecto es viable técnica y económicamente? Justificar la respuesta utilizando ejemplos concretos de recursos o limitaciones que podrían surgir en un entorno real de trabajo.**
	
5. **¿Qué elementos deberían analizar para tomar esta decisión, aplicado al caso asignado? Discutan las ventajas y desventajas de cada opción en términos de costo, flexibilidad, mantenimiento y escalabilidad.**
	
6. **Si son los líderes del equipo que enfrenta retrasos constantes en el proyecto del caso asignado ¿Qué medidas tomarían para optimizar la gestión del tiempo y los recursos del equipo sin sacrificar la calidad del proyecto? Analicen diferentes estrategias de liderazgo y planificación que podrían ser útiles en esta situación.**
	
7. **Con base al caso ¿Cómo procederían para identificar los síntomas clave del problema y proponer una solución tecnológica adecuada? Incluyan en su análisis el uso de técnicas como la observación del comportamiento de los empleados y la retroalimentación de los clientes.**
	
8. **Para el caso que están resolviendo, si se detecta que una de las tecnologías en uso podría volverse obsoleta en los próximos años. ¿Cómo abordarían este riesgo desde el punto de vista de la administración de proyectos? Discutan cómo el análisis de riesgos, la planificación a largo plazo y la selección de tecnologías podrían mitigar los efectos negativos de dicha obsolescencia.**
